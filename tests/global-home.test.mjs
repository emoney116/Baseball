...
test("completed practices do not appear in score-only recent activity", () => { assert.equal(globalHomeActivity(data({ practices: [{ id: "p", name: "Hitting", endedAt: "2026-09-08T13:00:00Z" }] }), now).recent.length, 0); });
