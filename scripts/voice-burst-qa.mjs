...
const filters=files.map((_,i)=>`[${i}:a]aresample=16000,silenceremove=start_periods=1:start_threshold=-35dB,areverse,silenceremove=start_periods=1:start_threshold=-35dB,areverse,${i===0?'adelay=350,':''}apad=pad_dur=0.55[a${i}]`);
