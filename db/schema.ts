...
export const games = pgTable("games", {
  ...
  activePlateAppearanceId: uuid("active_plate_appearance_id"),
  plateAppearanceNumber: integer("plate_appearance_number").default(1).notNull(),
  pitchNumberInPlateAppearance: integer("pitch_number_in_plate_appearance").default(0).notNull(),
  ...timestamps,
}, (table) => ({
...
export const plateAppearances = pgTable("plate_appearances", {
  ...
  appearanceNumber: integer("appearance_number"),
  inning: integer("inning"),
  half: text("half"),
  outsStart: integer("outs_start"),
  runnersStart: jsonb("runners_start"),
  scoreStart: jsonb("score_start"),
});
...
export const gamePitchEvents = pgTable("game_pitch_events", {
  ...
  eventKind: text("event_kind").default("pitch").notNull(),
  sequenceNumber: integer("sequence_number"),
  plateAppearanceId: uuid("plate_appearance_id").references(() => plateAppearances.id, { onDelete: "set null" }),
  plateAppearanceNumber: integer("plate_appearance_number"),
  pitchNumber: integer("pitch_number"),
  pitchNumberInPlateAppearance: integer("pitch_number_in_plate_appearance"),
  ...
  runnerId: uuid("runner_id").references(() => players.id, { onDelete: "set null" }),
  runnerBase: text("runner_base"),
  countBefore: jsonb("count_before"),
  countAfter: jsonb("count_after"),
  runnersBefore: jsonb("runners_before"),
  runnersAfter: jsonb("runners_after"),
