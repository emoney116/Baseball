...
const METRIC_FULL_NAMES: Record<string, string> = {
  ...
  fieldingActions: "Recorded Fielding Participation", throwActions: "Recorded Throw Participation", receiveActions: "Recorded Receiving Participation",
...
export const ANALYTICS_METRICS: AnalyticsMetricDefinition[] = [
  ...
  metric("fieldingActions", "Fielding actions", "defense", "integer", ["all", "practice", "live-bp"], "Player-play participations with an explicitly captured fielding role."),
  metric("throwActions", "Throw actions", "defense", "integer", ["all", "practice", "live-bp"], "Player-play participations with a captured throw role. Does not imply throw accuracy or an official assist."),
  metric("receiveActions", "Receives", "defense", "integer", ["all", "practice", "live-bp"], "Player-play participations with a captured receiving role. Not official putouts."),
...
export const ANALYTICS_COLUMN_PRESETS: Record<Exclude<AnalyticsColumnPreset, "custom">, string[]> = {
  ...
  position: [
    "errorPlays",
    "fieldingActions", "throwActions", "receiveActions",
...
export function analyticsSourcesForDomain(domain: AnalyticsDomain): AnalyticsSource[] {
  ...
  if (domain === "defense") return ["practice", "live-bp", "personal", "all"];
...
function view(
  ...
  if (domains.includes("defense") && sources.includes("practice")) sources = [...sources, "live-bp"];
...
function filter(
  ...
  if (domains.includes("defense") && supportedSources.includes("practice")) supportedSources = [...supportedSources, "live-bp"];
